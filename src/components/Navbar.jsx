  ...
  return (
    <div>
        <nav className='flex items-center justify-between p-4 bg-white text-black'>
            ...
            <button className='btn py-2 font-bold rounded-2xl px-8 border-2 border-red-500 text-red-500 cursor-pointer'>
                Log in
            </button>
            <button className='btn py-2 px-8 font-bold rounded-2xl border-2 border-red-500 text-white bg-red-500 cursor-pointer'>
                Sign Up
            </button>
            </div>
        </nav>
